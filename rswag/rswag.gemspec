...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'mn-rswag-specs', ENV['TRAVIS_TAG'] || '0.0.0'
  s.add_dependency 'mn-rswag-api', ENV['TRAVIS_TAG'] || '0.0.0'
  s.add_dependency 'mn-rswag-ui', ENV['TRAVIS_TAG'] || '0.0.0'
end
